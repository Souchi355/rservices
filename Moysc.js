function cal(){
 ...
 m("spc1","spc2","sps","spr");
 m("scc1","scc2","scs","scr");
 document.getElementById("gr").value=eval(document.getElementById("arr").value*2+"+"+document.getElementById("frr").value*2+"+"+document.getElementById("enr").value*2+"+"+document.getElementById("hisr").value+"+"+document.getElementById("geor").value+"+"+document.getElementById("isr").value+"+"+document.getElementById("madr").value+"+"+document.getElementById("mtr").value*4+"+"+document.getElementById("phyr").value*4+"+"+document.getElementById("tecr").value*2+"+"+document.getElementById("inr").value*1.5+"+"+document.getElementById("spr").value+"+"+document.getElementById("scr").value*2)/24.5
}
function reset() {
  function p(x){
